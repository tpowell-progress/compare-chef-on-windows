# Simplified script to compare chef-powershell gem directory before and after gem install
param(
...
try {
    ...
    Write-Host "Gem installation encountered an issue: `$(`$_.Exception.Message)"
...
"@
    ...
    docker run --rm -v "${PWD}\shared:C:\shared" chef-gem-compare:latest powershell -Command $initialScript
    ...
    docker run --rm -v "${PWD}\shared:C:\shared" chef-gem-compare:latest powershell -Command $finalScript
